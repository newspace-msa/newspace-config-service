...
<br>
newspace-config-service 입니다.
<br>
해당 레포지토리에는 컨피그 서버의 역할을 하는 스프링 부트 프로젝트가 포함되어있습니다.
<br>
...
└── src
    ...
    │   │       └── lgcns
    │   │           └── newspace
    │   │               └── NewspaceConfigServerApplication.java
    │   └── resources
    │       └── application.yml
    └── test
        └── java
            └── com
                └── lgcns
                    └── newspace
                        └── NewspaceConfigServerApplicationTests.java
```
<br/>
